<?php
/**
 * From wp-admin/media-new.php
 * Added hidden input wppmedia_private
 * 
 ...
 * Add in our var.
 */
function wppmedia_upload_post_params( $post_params ) {
    $post_params['wppmedia_private'] = 1;
    return $post_params;
}
add_filter( 'upload_post_params', 'wppmedia_upload_post_params' );
...
$title = __('Upload New Private Media');
...
<div class="wrap">
    ...
    <form enctype="multipart/form-data" method="post" action="<?php echo admin_url('wppmedia-new.php'); ?>" class="<?php echo esc_attr( $form_class ); ?>" id="file-form">
